...
public class AppConstants {
	...
	public static final String PLAN_SAVE_SUCC = "palnSaveSucc";
	...
	public static final String PLAN_STATUS_SUCC = "planStatusScc";
	
	public static final String PLAN_STATUS_FAIL = "planStatusFail";
